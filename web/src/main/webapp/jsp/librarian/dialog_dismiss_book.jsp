...
<html>
<head>
    <title><fmt:message key="dialog.dismiss_book"/>: #${params['id']}</title>
</head>
<body>
...
<div class="container col-lg-4">
    ...
    <form class="form" action="${abs_path}/controller" method="post">
        <input type="hidden" name="command" value="dismiss_book_to_user">
        <input type="hidden" name="id" value="${id}">
        <div class="card shadow">
            <div class="card-block">
                <h5 class="card-header"><fmt:message key="dialog.dismiss_book"/></h5>
                ...
                <div class="card-footer text-right">
                    <button type="submit" class="btn btn-danger"><fmt:message key="button.orders.dismiss"/></button>
