            ...
            <div class="card-block">
                ...
                <div class="card-text m-2">
                    <fieldset>
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-3" for="genreid"><fmt:message key="book.info.genre"/></label>
                            <div class="col-9">
                                ...
                                <span class="form-text small text-muted"><fmt:message key="tips.book.author_genre"/></span>
                                <span class="form-text small text-danger">${errors['genre']}</span>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-form-label col-3" for="authorid"><fmt:message key="book.info.author"/></label>
                            <div class="col-9">
                                ...
                                <span class="form-text small text-muted"><fmt:message key="tips.book.author_genre"/></span>
                                <span class="form-text small text-danger">${errors['author']}</span>
                            </div>
                        </div>
