            ...
            <div class="card-text">
                ...
                <table class="table table-bordered table-hover table-responsive" width="100%">
                    ...
                    <c:forEach var="author" items="${author_list}" varStatus="loop">
                        ...
                        <td style="text-align: center"><a href="${abs_path}/controller?command=edit_author_info&id=${author.id}"
                               class="${color} btn-sm"><i class="far fa-edit"></i></a>
                        </td>
                        <td style="text-align: center">
                            <c:if test="${!author.isDeleted}">
                                <a href="${abs_path}/controller?command=delete_author&id=${author.id}"
